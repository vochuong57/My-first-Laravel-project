<div class="seo-container">
    <div class="meta-title">
        {{ old('meta_title', (${moduleTemplate}->meta_title) ?? __('messages.seo_title')) }}
    </div>
    <div class="canonical">
        {{ old('canonical', (${moduleTemplate}->canonical)??'') ? config('app.url').old('canonical', (${moduleTemplate}->canonical)??'').config('apps.general.suffix') : __('messages.seo_canonical') }}
    </div>
    <div class="meta-description">
        {{ old('meta_description', (${moduleTemplate}->meta_description) ?? __('messages.seo_description')) }}
    </div>
</div>
