    ...
    <div class="uk-flex uk-flex-middle uk-flex-space-between">
        ...
        <div class="action">
            <div class="uk-flex uk-flex-middle">
                ...
                <select name="product_catalogue_id" class="form-control ml10 setupSelect2">
                ...
                <a href="{{ route('product.store') }}" class="btn btn-danger ml10"><i class="fa fa-plus mr5"></i>{{ __('messages.product.create.title') }}</a>
            </div>
        </div>
    </div>
</div>
